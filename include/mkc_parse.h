...
/* mkc_parse.c */
MKC_NODISCARD mkc_parse_t * mkc_parse_init (astmain_t *astmain, mkc_log_t *log, mkc_error_t *mkcerr);
...
/* mkc_grammar.y */
int mkc_parse (mkc_parse_t *parse, void *scanner, astmain_t *astmain, mkc_error_t *mkcerr);
void mkc_parse_debug (mkc_parse_t *parse, bool debug);
