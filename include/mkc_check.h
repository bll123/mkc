...
MKC_NODISCARD mkc_check_t *mkc_check_init (mkc_profile_t *profiles, scope_t *scope, mkc_attribute_t *attr, mkc_log_t *log, mkc_profidx_t pixd_global_general, mkc_error_t *mkcerr);
