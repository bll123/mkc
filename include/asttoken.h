...
typedef enum {
  ...
  MKC_T_OP_AND,
  MKC_T_OP_DIVIDE,
  MKC_T_OP_FILE_EXISTS,
  MKC_T_OP_IS_DEFINED,
  MKC_T_OP_IS_DICT,
  MKC_T_OP_IS_DIRECTORY,
  MKC_T_OP_IS_LIST,
  MKC_T_OP_MINUS,
  MKC_T_OP_MODULO,
  MKC_T_OP_MULTIPLY,
  ...
  MKC_T_OP_UNARY_PLUS,
  MKC_T_RETURN,
  MKC_T_STMT_AUTOBUILD,
  MKC_T_STMT_BUILD,
  MKC_T_STMT_CHK_INC_COMPILE,
  MKC_T_STMT_CHK_INC_DEPS,
  MKC_T_STMT_CHK_INC_GUARDS,
  MKC_T_STMT_CONFIGURE,
  MKC_T_STMT_EXECUTABLE,
  MKC_T_STMT_DEBUG,
  MKC_T_STMT_ELSEIF,
  MKC_T_STMT_EXIT,
  MKC_T_STMT_FOREACH,
