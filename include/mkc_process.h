...
int32_t mkc_process_condition (mkc_process_t *process, value_t *value);
int32_t mkc_process_num_op (mkc_process_t *process, mkc_astnode_token_t type, value_t *vala, value_t *valb);
int32_t mkc_process_str_op (mkc_process_t *process, mkc_astnode_token_t type, value_t *stra, value_t *strb);
int32_t mkc_process_unary_op (mkc_process_t *process, mkc_astnode_token_t type, value_t *vala);
int32_t mkc_process_other_op (mkc_process_t *process, mkc_astnode_token_t type, value_t *vala);
void mkc_process_include (mkc_process_t *process, value_t *valpath, value_t *valfn, char *tbuff, size_t sz);

mkc_foreach_t *mkc_process_stmt_foreach_setup (mkc_process_t *process, value_t *valnm, value_t *vallist);
...
void mkc_process_attribute (mkc_process_t *process, value_t *name, mkc_astnode_token_t asttype);
void mkc_process_attr_comp_flags (mkc_process_t *process, value_t *value);
...
int32_t mkc_process_check (mkc_process_t *process, value_t *valtype, mkc_astnode_token_t asttype);
int32_t mkc_process_check_flag (mkc_process_t *process, value_t *valflag, int addchk, mkc_astnode_token_t asttype);
