...
void scopedvar_push (scopedvar_t *scopedvar, scopedvar_type_t svtype, const char *name);
...
int scopedvar_set (scopedvar_t *scopedvar, scopedvar_type_t svtype, const char *vname, value_t *value, value_ctxt_t vctxt);
int scopedvar_set_integer (scopedvar_t *scopedvar, scopedvar_type_t svtype, const char *vname, int32_t ival, value_ctxt_t vctxt);
int scopedvar_set_timestamp (scopedvar_t *scopedvar, scopedvar_type_t svtype, const char *vname, time_t tmval, value_ctxt_t vctxt);
int scopedvar_set_str (scopedvar_t *scopedvar, scopedvar_type_t svtype, const char *vname, const char *str, value_ctxt_t vctxt);
int scopedvar_set_list (scopedvar_t *scopedvar, scopedvar_type_t svtype, const char *vname, mkc_list_t *list, value_ctxt_t vctxt);
int scopedvar_set_list_from_str (scopedvar_t *scopedvar, const char *vname, char *str, value_ctxt_t vctxt);
int scopedvar_append_str_list (scopedvar_t *scopedvar, scopedvar_type_t svtype, const char *vname, const char *data, value_ctxt_t vctxt);
