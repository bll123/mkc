...
void comptest_append_arg (comptest_t *comptest, const char *arg);
void comptest_append_comp_flag (comptest_t *comptest, const char *flag);
void comptest_append_link_flag (comptest_t *comptest, const char *flag);
